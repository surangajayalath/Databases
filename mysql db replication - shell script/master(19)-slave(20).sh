...
ssh osssupport@192.168.143.20 sudo sed -i 's/server-id=1/server-id=2/g' /etc/my.cnf
ssh osssupport@192.168.143.20 sudo sed -i 's/log-bin=mysql-bin/#log-bin=mysql-bin/g' /etc/my.cnf
ssh osssupport@192.168.143.20 sudo sed -i 's/#replicate-wild-do-table=heimdall.%/replicate-wild-do-table=heimdall.%/g' /etc/my.cnf
ssh osssupport@192.168.143.20 sudo sed -i 's/#replicate-wild-do-table=bifrost.%/replicate-wild-do-table=bifrost.%/g' /etc/my.cnf
...
MASTER_HOST=192.168.143.19
SLAVE_HOSTS=192.168.143.20
